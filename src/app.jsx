...
function InputTab(_ref29) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      fontSize: 12,
      flexShrink: 0,
      background: saveState === "saved" ? C.green : hasUnsaved ? "linear-gradient(135deg,".concat(C.accent, ",").concat(C.blue, ")") : C.b2,
      color: "#fff",
      boxShadow: hasUnsaved && saveState === "idle" ? "0 0 14px ".concat(C.accent, "50") : "none",
      transition: "all .2s"
    }
  }, saveState === "saving" ? "저장중..." : saveState === "saved" ? "✓ 완료" : "💾 저장")), inputMode === "bulk" && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 10
...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, isMobile ? t.l : "".concat(t.i, " ").concat(t.l));
  }), /*#__PURE__*/React.createElement("a", {
    href: "plan.html",
    style: {
      padding: isMobile ? "5px 8px" : "5px 12px",
  ...
  }, isMobile ? "달성" : "📋 달성계획")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: "auto",
      display: "flex",
      alignItems: "center",
  ...
  }, theme === 'light' ? '라이트' : '다크')), /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.muted,
      fontSize: 9
    }
  }, APP_VER), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 3,
  ...
  }, hasUnsaved && saveState === "idle" && /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.orange,
      fontSize: 10,
      fontWeight: 600
  ...
  }, "\uC0B0\uCD9C\uAE30\uC900"), [["대외영업", "혼수+입주+이사+SMB+농협+거주중+휴대폰", C.blue], ["뉴홈", "입주+이사", C.green], ["B2B", "SMB+농협+휴대폰", C.orange], ["CE비중", "각항목÷CE", C.accent], ["달성률", "실적÷목표×100", C.teal]].map(function (_ref57) {
